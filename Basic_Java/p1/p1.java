...
class Student{
	...
	public int[] returnMarks(){return marks;}
	...
	public void displayCGPA(){System.out.println("CGPA :"+cgpa);}
...
class StudentList{
	...
	String dept;
	String sub[]=new String[5];String sub1;
	...
	public void admitStudent(){
		...
		while(true){
			...
			if(count+1<10){r=r+"00"+(count+1);}
			else if(count+1>=10 && count+1<=99){r=r+"0"+(count+1);}
			else {r=r+(count+1);};
			obj.setRoll(r);
			list[count]=obj;
			count++;
			...
			choice=s.nextLine();
			if(choice.equals("y") || choice.equals("Y")){return;}
			else {System.out.print("\033\143");System.out.println("Admiting next student");};
		}
	};
...
class Engineering{
	...
	public void admission(){
		...
		choice=s.nextInt();
		if(choice==1) BCSE.admitStudent();
		else if(choice==2) ETCE.admitStudent();
		else if(choice==3) CIVL.admitStudent();
		else if(choice==4) ARCH.admitStudent();
		else return;
	};
	...
	public void enquiry(){
		...
		roll=s.nextInt()-1;
		if(choice==1) {BCSE.list[roll].displayData();s.nextLine();s.nextLine();}
		else if(choice==2) {ETCE.list[roll].displayData();s.nextLine();s.nextLine();}
		else if(choice==3) {CIVL.list[roll].displayData();s.nextLine();s.nextLine();}
		else if(choice==4) {ARCH.list[roll].displayData();s.nextLine();s.nextLine();}
		else return;
	};
	...
	public void ranklist(){
		...
		choice=s.nextInt();
		System.out.print("\033\143");
		if(choice==1) {BCSE.prepareRanklist();BCSE.displayRanklist();}
		else if(choice==2) {ETCE.prepareRanklist();ETCE.displayRanklist();}
		else if(choice==3) {CIVL.prepareRanklist();CIVL.displayRanklist();}
		else if(choice==4) {ARCH.prepareRanklist();ARCH.displayRanklist();}
		else return;
	}
...
public class p1{
	public static void main(String[] args){
		...
		while(true){
			...
			choice=s.nextInt();
			if(choice==1) obj.enquiry();
			else if(choice== 2) obj.ranklist();
			else {System.out.print("\033\143");System.out.println("THANK YOU");break;};
		};
